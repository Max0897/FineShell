...
当前已完成真实密码、私钥和 SSH Agent 连接、SOCKS5 与 HTTP CONNECT 代理、一级跳板机、本地/远程/动态 SOCKS5 端口转发、主机指纹确认、SSH 保活与自动重连、远程 PTY、带内容搜索、动态参数快捷命令和固定主机首页的多标签终端、支持暂停取消、批量拖拽、远程复制移动和文本安全编辑的 SFTP 文件管理、服务器监控、系统凭据库存储、三面板工作区和独立全局设置窗口。后续功能与优先级见 `TODO.md`。
